...
- 功能齐全：原四章节 BI 报表、人员3口径第五章节、四维筛选、两个旧口径下载按钮（数值版 + 含公式核算版）、
  图表/大数字/业务单元汇总数字点击明细下钻弹窗。测试 29 passed；核算版公式已用
...
- 2026-07-14 人员3口径 phase 4 完成:
  - 第五章节新增“下载人员3结果”和“下载人员3核算版”，导出使用当前人工确认状态，
    不受页面顶部旧报表筛选影响，也不改变原四章节下载。
...
- 2026-07-14 人员3口径完整公式链补强:
  ...
  - UI明确提示以后只需上传三张 input，并将公式按钮改为“下载完整核算工作簿（含公式）”。
